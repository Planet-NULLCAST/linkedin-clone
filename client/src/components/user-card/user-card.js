...
function UserCard() {
    ...
    const [imageUrl, setImageUrl] = useState('./Assets/profilepic.jpg');
        ...
        <div id = 'div' className='flex'>
            <div className='w-100 h-350 md:w-60 border border-primary rounded-lg'>
                <div className='relative '>
                    ...
                    <img src={imageUrl} alt='profile pic' className='cursor-pointer absolute left-44 top-78 md:left-20 md:top-50 h-14 rounded-full h-35 w-29' />
                </div>
            ...
            { modal && <div className='shadow-lg w-744 m-6 rounded-lg border border-primary bg-white'>
                ...
                <div className='pt-10 pb-12 border-b border-primary flex flex-col items-center'>
