...
function UserCard({ showUserCard }) {
  ...
  return (
    <div className="w-auto md:w-60 ">
      <div className="border border-primary rounded-lg bg-white">
        <div className="relative ">
          ...
          <img
            src={profilePicUrl}
            alt="profile pic"
            className="cursor-pointer absolute left-44 top-78 md:left-20 md:top-50 h-14 rounded-full  w-29"
          />
        </div>
        ...
        <div className={`${showUserCard} md:${show}`}>
          <div className="mt-3 md:pb-3 border-b border-primary">
            ...
            <h3 className="pl-3.5 text-xs cursor-pointer text-sec text-opacity-60 font-semibold leading-7 hover:bg-primary">
              Connections
            </h3>
          </div>
          ...
          <div className="shadow-lg sm:w-744  rounded-lg border border-primary bg-white">
            <header className="flex justify-between py-4 px-6 border-b border-primary">
              ...
              <h1
                ...
                className="cursor-pointer rounded-full hover:bg-gray-300 p-2 text-base"
              >
                X
              </h1>
            </header>
            ...
            <footer>
              <div className="relative py-4 px-6 flex justify-end">
                ...
                <label
                  for="photo"
                  className="w-auto hover:bg-blue-900 cursor-pointer bg-blue-600 py-1.5 px-4 rounded-b-2xl rounded-t-2xl text-white sm:font-semibold"
                >
                  Upload photo
                </label>
                </form>
      ...
      {cropmodal && (
        <div className="absolute flex -top-0 -left-0 z-20 justify-center items-center w-full h-full bg-gray-900 bg-opacity-10">
          <div className="h-auto shadow-lg border border-primary m-6 w-680 rounded-lg">
            ...
            <footer className="flex justify-end py-4 px-6 bg-white">
              ...
              <label
                for="changephoto"
                className="mr-4 hover:border-8 cursor-pointer hover:bg-gray-100 py-1.5 px-4 rounded-b-2xl rounded-t-2xl text-gray-500 border border-gray font-semibold"
              >
                Change photo
              </label>
      ...
      {popup && (
        <div className="absolute w-full -top-0 -left-0 z-30 h-full flex justify-center items-center">
          <div className="sm:w-81 bg-white rounded-lg">
            <header className="flex justify-between px-4 pt-4 border-b border-primary">
              <h1>Discard Changes</h1>
              <h1
                className="cursor-pointer rounded-full hover:bg-gray-300 pb-2 pt-0.5 text-base"
            ...
            <div className="p-4 border-b border-primary">
              <p className="text-sec text-opacity-90 text-base">
            ...
            <footer className="flex justify-end py-3 px-4">
              <button
                type="button"
                onClick={() => setPopup(false)}
                className="mr-4 hover:border-4 hover:bg-blue-100 py-1.5 px-4 rounded-b-2xl rounded-t-2xl text-blue-700 border-2 border-blue-700 font-semibold"
              >
                Cancel
              </button>
              <button
