        ...
        <div>
          <div className="h-14 flex  items-center px-0  justify-center  ">
            <div className="items-center justify-center flex">
              <div className="mr-2">
                <i class="fab fa-linkedin text-blue-500 text-4xl"></i>
              </div>
            ...
            <ul className="items-center flex ">
              <li>
                <button className="w-12 lg:w-20  border-b-4 border-transparent text-xs opacity-60 hover:opacity-100	focus:opacity-100 focus:border-black flex flex-col justify-center items-center h-14">
                  <i class="fas fa-home lg:text-base text-2xl"></i>
              ...
              <li>
                <button className="w-12 lg:w-20 border-b-4 border-transparent text-xs opacity-60 hover:opacity-100	focus:opacity-100	 focus:border-black flex flex-col justify-center items-center h-14">
                  <i class="fas fa-briefcase lg:text-base text-2xl"></i>
                  <p className="hidden lg:flex">Jobs</p>
                </button>
              </li>
              <li>
                <button className="w-12 lg:w-20 border-b-4 border-transparent text-xs opacity-60 hover:opacity-100	focus:opacity-100	 focus:border-black flex flex-col justify-center items-center h-14">
                  <i class="fas fa-comment-dots lg:text-base text-2xl"></i>
                  <p className="hidden lg:flex">Messaging</p>
                </button>
              </li>
              <li>
                <button className="w-12 lg:w-20 border-b-4 border-transparent text-xs opacity-60 hover:opacity-100	focus:opacity-100	 focus:border-black flex flex-col justify-center items-center h-14">
                  <i class="fas fa-bell lg:text-base text-2xl"></i>
          ...
          {workPopup ? (<div className="absolute  -left-0  flex justify-end  w-full h-screen bg-black bg-opacity-40"><div className="  min-h-screen w-96 rounded-l-2xl mt-px shadow-lg justify-start  items-center bg-white z-50 flex flex-col ">
              ...
              <div className='border py-2.5'>
                <div className='flex opacity-80'> 
                  <div className='justify-center flex items-center w-20 h-16'>
                    <button className='flex flex-col justify-center items-center text-xs'><i class="fab border text-2xl rounded w-10 h-10 flex justify-center items-center fa-youtube  text-blue-500"></i>Learning</button>
                  </div>
                  <div className='justify-center flex items-center  w-20 h-16'>
                    <button className='flex flex-col justify-center items-center text-xs'><i class="far fa-chart-bar text-2xl border  rounded  flex justify-center items-center text-blue-500 w-10 h-10"></i>Insights</button>
                  </div>
                  <div className='justify-center flex items-center w-20 h-16'>
                    <button className='flex flex-col justify-center items-center text-xs'><i class="far fa-clipboard text-2xl border  rounded  flex justify-center items-center text-blue-500 w-10 h-10"></i>Post a job</button>
                  </div>
                  <div className='justify-center flex items-center w-20 h-16'>
                    <button className='flex flex-col justify-center items-center text-xs'><i class="fas fa-bullseye text-2xl border  rounded  flex justify-center items-center text-blue-500 w-10 h-10"></i>Advertise</button>
                  </div>
                </div>
                <div className='flex opacity-80'> 
                  <div className='justify-center flex items-center w-20 h-16'>
                    <button className='flex flex-col justify-center items-center text-xs'><i class="fas fa-compass text-2xl border  rounded  flex justify-center items-center text-blue-500 w-10 h-10"></i>Find Leads</button>
                  </div>
                  <div className='justify-center flex items-center w-20 h-16'>
                    <button className='flex flex-col justify-center items-center text-xs'><i class="fas fa-users text-2xl border  rounded  flex justify-center items-center text-blue-500 w-10 h-10"></i>Groups</button>
                  </div>
                  <div className='justify-center flex items-center w-20 h-16'>
                    <button className='flex flex-col justify-center items-center text-xs mt-4'><i class="far fa-check-square text-2xl border  rounded  flex justify-center items-center text-blue-500 w-10 h-10"></i>Services Marketplace</button>
                  </div>
                  <div className='justify-center flex items-center w-20 h-16'>
                    <button className='flex flex-col justify-center items-center text-xs'><i class="fas fa-money-bill-alt text-2xl border  rounded  flex justify-center items-center text-blue-500 w-10 h-10"></i>Salary</button>
                  </div>
                </div>
              </div>
              <div className='mt-4 flex-col opacity-80'>
              <div className='border flex py-2.5'>
                <label className='pl-5 font-bold opacity-80'>LinkedIn Business Services</label>
              </div>
              <div className='border flex pb-4 flex-col'>
                <a href='##' className='pl-5  mt-2 font-bold'>Talent Solutions</a>
                <a href='##' className='pl-5  text-sm'>Find, attract and recruit talent</a>
                <a href='##' className='pl-5 mt-2 font-bold'>Sales Solutions</a>
                <a href='##' className='pl-5  text-sm'>Unlock sales opportunities</a>
                <a href='##' className='pl-5 mt-2 font-bold'>Post a job for free</a>
                <a href='##' className='pl-5  text-sm '>Get your job in front of quality candidates</a>
                <a href='##' className='pl-5 mt-2 font-bold'>Marketing Solutions</a>
                <a href='##' className='pl-5  text-sm '>Acquire customers and grow your business</a>
                <a href='##' className='pl-5 mt-2 font-bold'>Learning Solutions</a>
                <a href='##' className='pl-5 text-sm  '>Develop talent across your organization</a>
              </div>
              <div className='border flex py-2.5 items-center'>
                <a href='###' className='pl-5 font-bold'> Create a Company Page <i class="fas fa-plus"></i></a>
              </div>
              </div>
            </div>
          </div></div>):null}
